<form action="/" method="GET" class="generator-form" id="generator-form">
  <div class="generator-form__field">
    ...
    <input require type="text" class="field__input" name="first-name" title="<?= $localeReader->translate('First Name'); ?>">
  </div>
  <div class="generator-form__field">
    <p class="field__title"><?= $localeReader->translate('Last Name'); ?></p>
    <input require type="text" class="field__input" name="last-name" title="<?= $localeReader->translate('Last Name'); ?>">
  </div>
  <div class="generator-form__field">
    <p class="field__title"><?= $localeReader->translate('Middle Name'); ?></p>
    <input type="text" class="field__input" name="middle-name" title="<?= $localeReader->translate('Middle Name'); ?>">
  </div>
